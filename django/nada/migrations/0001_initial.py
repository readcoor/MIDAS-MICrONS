...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bin_table', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='neuron_to_bin', to='nada.Bin_Table_Default')),
                ('experiment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='neuron_to_bin', to='nada.Experiment')),
                ('neuron', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='neuron_to_bin', to='nada.Neuron')),
            ],
        ),
        migrations.CreateModel(
            name='NeuronActivity',
