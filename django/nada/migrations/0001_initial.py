# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-03-13 20:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255, validators=[nada.models.validators.NameValidator()], verbose_name='Name of the Channel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='neurons', to='nada.Channel')),
                ('experiment', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='neurons', to='nada.Experiment')),
            ],
            bases=(nada.models.util.NameLookupMixin, nada.models.neurons.CECIMixin, models.Model),
        ),
        migrations.CreateModel(
            name='Neuron_To_Mesh',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='synapses', to='nada.Channel')),
        ...
        migrations.AddField(
            model_name='channel',
            name='experiment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='channels', to='nada.Experiment'),
        ),
